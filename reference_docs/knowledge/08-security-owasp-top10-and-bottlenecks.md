...
- **Wearable payload abuse or schema smuggling**: The isolated future batch contract requires `1–100` entries and rejects undeclared fields at the batch and nested-entry levels. The live endpoint remains receipt-only until hashing and persistence are implemented.
