workspace "SyncVitals Current AWS V007" "Verified presentation-staging deployment state after creating and validating the backend runtime secret on 2026-09-04." {
    model {
        currentAwsV007 = deploymentEnvironment "[CURRENT AWS V007] Runtime Secret Created" {
            ...
            aws = deploymentNode "AWS Account 173291122778" "Manually provisioned presentation-staging account. Frontend delivery, the accepted backend image, and the validated runtime secret exist; no EC2, EBS, Elastic IP, Nginx, Django, PostgreSQL, or staging CloudWatch resource exists yet." {
                tags "CloudZone"
    ...
    views {
        deployment * currentAwsV007 "current-aws-v007" "[CURRENT AWS V007] Actual state: V006 plus the validated regional runtime secret; instance-role retrieval and API compute do not exist yet." {
            include *
