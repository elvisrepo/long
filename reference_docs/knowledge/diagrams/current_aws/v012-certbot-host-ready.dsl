workspace "SyncVitals Current AWS V012" "Verified presentation-staging deployment state after installing and validating Certbot, its Route 53 DNS plugin, and the automatic renewal timer on 2026-09-07." {
    model {
        currentAwsV012 = deploymentEnvironment "[CURRENT AWS V012] Certbot Host Ready" {
    ...
    views {
        deployment * currentAwsV012 "current-aws-v012" "[CURRENT AWS V012] Actual state: V011 plus verified Certbot DNS-01 tooling and an active automatic renewal timer. No origin certificate has been requested, and DNS, Nginx TLS, reverse proxying, application containers, and persistent PostgreSQL storage remain unchanged." {
            include *
