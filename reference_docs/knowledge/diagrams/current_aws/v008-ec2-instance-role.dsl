workspace "SyncVitals Current AWS V008" "Verified presentation-staging deployment state after creating and restricting the future EC2 instance role on 2026-09-04." {
    model {
        currentAwsV008 = deploymentEnvironment "[CURRENT AWS V008] EC2 Instance Role" {
            ...
            aws = deploymentNode "AWS Account 173291122778" "Manually provisioned presentation-staging account. Frontend delivery, the accepted backend image, the validated runtime secret, and the restricted EC2 instance role exist; no EC2, EBS, Elastic IP, Nginx, Django, PostgreSQL, or staging CloudWatch resource exists yet." {
                tags "CloudZone"
    ...
    views {
        deployment * currentAwsV008 "current-aws-v008" "[CURRENT AWS V008] Actual state: V007 plus the restricted EC2 instance role and profile; no EC2 host or API compute exists yet." {
            include *
