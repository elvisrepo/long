...
- Periodic WorkManager scheduling/cancellation, physical background-permission verification, Celery-backed asynchronous ingestion, and production distribution remain later phases.
