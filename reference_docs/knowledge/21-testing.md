...
- The first API boundary test now proves that `GET /api/v1/wearables/connections/` rejects unauthenticated requests; caller-scoped list behavior is the next test.
