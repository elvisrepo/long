...
- Frontend formatter coverage proves `sleep_duration` decimal hours display as rounded hours and minutes (`7.5` becomes `7h 30m`) without appending a duplicate `hours` unit.
