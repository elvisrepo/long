...
- The previous eight instrumented tests pass on the physical `FCP-N49` phone. The two new session-checking/logout Compose tests compile; a focused/full on-device instrumentation rerun remains a separate automated gate.
