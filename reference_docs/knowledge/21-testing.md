...
- Subscription-update coverage proves scheduled cancellation stores Stripe `cancel_at`, normalizes period-end cancellation into local `cancel_at_period_end`, updates the billing period, and preserves the active paid plan.
